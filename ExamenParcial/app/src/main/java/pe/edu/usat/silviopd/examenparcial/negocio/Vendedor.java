...
public class Vendedor extends AccesoDatos {
    ...
    public Cursor leerDatos(String dni){
        ...
        String sql ="select v.dni," +
                ...
                "z.codigo_distrito," +
                "v.ruta " +
                "from vendedor v inner join linea_producto l on v.codigo_linea=l.codigo_linea inner " +
                "join zona z on v.codigo_zona=z.codigo_zona " +
                "inner join distrito d on z.codigo_distrito=d.codigo_distrito " +
                "where v.dni like '" + dni + "'";
    ...
    public long editar(){
        ...
        String condicion = "dni like '"+this.getDni()+"'";
